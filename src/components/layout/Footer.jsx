    ...
    <footer className="bg-gray-900 text-white pt-16 pb-6 px-4" id="footer">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Company info */}
          <div>
            <h3 className="text-2xl font-bold mb-6">TravelNest</h3>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">
                  123 TravelNest Way, Traveler's District, Adventure Land
                </span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">hello@TravelNest.travel</span>
              </li>
              <li className="flex items-center">
        ...
        <p className="text-gray-500 text-sm text-center">
          &copy; 2025 TravelNest Travel. All rights reserved.
        </p>
      </div>
     </div>
    </footer>
